...
//   useEffect(() => {
//     // Animate the Spline object based on scroll position
...
//           {/* Feature 1 with parallax */}
//           <div ref={ref1} className="relative overflow-hidden">
//             <motion.div
//               className="absolute -z-10 w-64 h-64 bg-primary/10 rounded-full right-0 top-0"
//               style={{ y: y1 }}
//             />
//             <motion.div
...
//                 </h3>
//                 <p className="text-lg">
//                   All content on Quranium is verified by scholars and experts,
...
//           {/* Feature 2 with parallax */}
//           <div ref={ref2} className="relative overflow-hidden">
//             <motion.div
//               className="absolute -z-10 w-80 h-80 bg-secondary/10 rounded-full left-0 bottom-0"
//               style={{ y: y2 }}
//             />
//             <motion.div
//               className="grid md:grid-cols-2 gap-8 items-center"
...
//                 </h3>
//                 <p className="text-lg">
//                   Contribute, learn, and earn rewards through our
//                   blockchain-based ecosystem.
//                 </p>
//               </div>
//               <div className="md:order-1 bg-gradient-to-br from-secondary/10 to-primary/10 rounded-lg aspect-video flex items-center justify-center">
//                 <div className="text-6xl">🏆</div>
//               </div>
//             </motion.div>
//           </div>

//           {/* Feature 3 with parallax */}
//           <div ref={ref3} className="relative overflow-hidden">
//             <motion.div
//               className="absolute -z-10 w-72 h-72 bg-primary/10 rounded-full right-0 bottom-0"
//               style={{ y: y3 }}
//             />
//             <motion.div
//               className="grid md:grid-cols-2 gap-8 items-center"
...
//                 </h3>
//                 <p className="text-lg">
//                   Connect with others, participate in discussions, and grow
...
//             <motion.div
//               key={index}
//               className={`absolute w-6 h-6 -left-[11px] rounded-full border-2 transition-colors duration-500 ${
//                 activeFeature === index
//                   ? `bg-${features[index].highlight} border-${features[index].highlight}`
...
//                             color: [
//                               null,
//                               `var(--tw-colors-${feature.highlight})`,
//                               null,
//                             ],
//                             transition: {
//                               duration: 1.5,
